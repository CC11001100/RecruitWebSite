		...
		<div class="container">
			...
			<div>
				<ol class="breadcrumb">
					...
					<li class="active">编辑公司资料</li>
				</ol>
			</div>
			<div class="">
				<div>

					<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<c:url value="/companyHr/editCompany"/>">
						<fieldset>

							<div id="legend" class="">
								<legend class="">编辑公司资料</legend>
							</div>
							
							<div class="form-group">
								<label for="name" class="col-sm-2 control-label">公司名：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="name" name="company.name" placeholder="20字以内" value="${company.name }">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<b>创业公司</b>
									<input id="person_scale" name="person_scale" type="text" class="" value="" data-slider-min="10" data-slider-max="1000" data-slider-step="1" data-slider-value="[${company.personScaleLow },${company.personScaleHigh }]"/>
									<b>行业巨头</b>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="contact" name="company.contact" placeholder="请输入有效的联系方式，50字以内" value="${company.contact }">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea type="text" class="form-control" id="descContent" name="company.descContent" placeholder="请输入职位描述，3000字以内">${company.descContent }</textarea>
								</div>
							</div>
							
							<div class="form-group">
								<div class="col-sm-4 col-lg-offset-5">
									<button class="btn btn-success" type="submit" id="editCompanyBtn">确认修改</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
